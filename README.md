...
신입 네트워크 엔지니어 교육용 실습 랩. Proxmox VE 위에 **14노드 네트워크를 코드로 세우고**,
...
| 구성 | 내용 |
|---|---|
| 랩 토폴로지 | VM 14대 — PC 2 · 스위치 2 · 라우터 5 · 경계 장비 1 · 서버 3(web/ftp/dns) · 외부망 1 + 링크 브리지 16개 |
...
- 용량 기준: 랩당 RAM 9.5 GiB. 호스트 RAM 64 GiB 에서 **6랩** 권장.
